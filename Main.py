...
def debug():
    global p1_in_ground, p_pos, p_rect, p_speed, p_image_f, p_speed_max, p_facingR, p_facingL, dt
    ...
    speed = f"Speed: {p_speed:.0f}"
    debug_surface = font.render(speed, True, (255, 0, 0))
    screen.blit(debug_surface, (10, 70))
    facing = f"Facing: {'Right' if p_facingR else 'Left'}"
    debug_surface = font.render(facing, True, (255, 0, 0))
    screen.blit(debug_surface, (10, 90))
    dt_display = f"dt: {dt:.4f}"
